...
export default function Footer() {
  return (
    <footer className="relative w-full bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div className="w-[400px] h-[100px] bg-emerald-500/10 blur-[80px] rounded-full" />
      </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-6 flex flex-col items-center gap-3" data-aos="fade-up">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4">
          ...
          <div className="flex items-center gap-2 group">
            <div className="p-1.5 rounded-md bg-emerald-500/10 border border-emerald-500/20 group-hover:bg-emerald-500/20 transition-all duration-300">
        ...
        <div className="flex items-center gap-2">
          ...
          <p className="text-slate-400 text-xs italic tracking-widest font-light">
