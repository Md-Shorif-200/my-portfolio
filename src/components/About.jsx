      ...
      <Container>
        ...
        <section   >
          <div className=" about_section w-full  flex flex-col lg:flex-row       gap-x-6   ">
            ...
            >
              <h2
                className="w-[130px] py-1 text-center text-md font-semibold bg-primary-soft rounded-full uppercase primary_color flex justify-center items-center gap-1"
                data-aos="fade-up"
                data-aos-delay="300"
              >
                <BsStars />
              ...
              <p
                className="text-base text-subtle mt-3 text-justify "
                data-aos="fade-up"
                data-aos-delay="250"
              >
              ...
              <p
                className="text-base text-subtle mt-3  "
                data-aos="fade-up"
                data-aos-delay="300"
              >
                As a{" "}
                <span className="primary_color font-semibold capitalize">
                  web Developer
                </span>{" "}
                at{" "}
                <span className="primary_color font-semibold capitalize">
              ...
              <div
                ...
                data-aos-delay="400"
              >
                <p className="text-base text-subtle mt-3  ">
