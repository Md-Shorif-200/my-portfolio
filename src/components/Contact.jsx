    ...
    <main className="w-full  bg_color ">
      <Container>
        <div className="text-center py-10" data-aos="fade-up">
          ...
          <p className="text-subtle mt-4 capitalize ">
      ...
      <Link
        ...
        className="w-10 h-10 bg-primary-soft-strong hover:bg-slate-950 transition-all flex justify-center items-center text-lg rounded-full "
      >
