...
const FeaturedSection = () => {
  ...
  className="featurd_card relative overflow-hidden border-[3px] border-primary rounded-xl text-center py-4 cursor-pointer group"
          data-aos="fade-up"
...
>
  ...
  <div className="relative z-10 text-whtie group-hover:text-white transition duration-300">
    ...
    <div className="capitalize text-base text-subtle">
      <p>{data.desc}</p>
    </div>
  </div>
</motion.div>
