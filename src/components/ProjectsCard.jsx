          ...
          {filteredProjects.map((project, index) => {
            ...
            return (
              <motion.article
                ...
                className="group relative rounded-2xl overflow-hidden bg-surface border border-soft shadow-md hover:shadow-2xl transition-all duration-500 flex flex-col"
              >
                ...
                <div className="relative h-[220px] overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200">
                  ...
                  <div className="absolute top-4 right-4 z-20">
                    <span className="px-3 py-1 bg-surface/90 backdrop-blur-sm rounded-full text-xs font-bold text-heading shadow-lg border border-soft">
                ...
                <div className="p-6 flex flex-col justify-between flex-1 relative z-20">
                  <div>
                    ...
                    <p className="text-sm text-subtle font-medium mt-2 capitalize flex items-center gap-2">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {previewTech.map((tech, i) => (
                        <motion.span
                          ...
                          className="px-3 py-1.5 text-xs font-semibold rounded-lg bg-surface-muted text-subtle border border-soft hover:text-primary hover:shadow-md transition-all duration-300 cursor-default"
                        >
                          {tech}
                        </motion.span>
                      ))}
                    ...
                    <div className="flex gap-2">
                      ...
                      <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.98 }}>
                        <button
                          ...
                          border-2 border-soft text-subtle hover:border-primary hover:text-primary 
                          hover:bg-primary-soft transition-all duration-300 group/btn cursor-pointer"
                        >
...
function IconBtn({ href, children, label, primary }) {
  ...
  return (
    <Link
      ...
      ${
        primary
          ? "bg-gradient-to-r from-primary to-primary-hover text-white shadow-lg shadow-primary/30 hover:shadow-xl hover:shadow-primary/40"
...
function SecondaryBtn({hideButton, href, children, label }) {
  ...
  return (
    <Link
      ...
      border-2 border-soft text-subtle hover:border-primary hover:text-primary 
      hover:bg-primary-soft transition-all duration-300 w-full relative overflow-hidden"
    >
